...
import { StripeElements, StripePaymentElement, StripeService } from '@services/stripe.service';
...
@Component({
    ...
    <div class="dialog" role="dialog" aria-modal="true">
      ...
      <section *ngIf="step === 'payment'" class="payment">
        ...
        <div *ngIf="stripeMode" class="stripe-block">
          <p class="muted">
            Vous payez en une fois via Stripe. Kapyo répartira ensuite le paiement
  ...
  styles: [`
    ...
    header {
      ...
      padding: 16px 20px; border-bottom: 1px solid var(--kapyo-border);
    }
    ...
    fieldset {
      border: 1px solid var(--kapyo-border); border-radius: 8px; padding: 14px;
      display: flex; flex-direction: column; gap: 10px;
    }
    legend { padding: 0 6px; color: var(--kapyo-muted); font-size: 12px; text-transform: uppercase; letter-spacing: 0.05em; }
    label { display: flex; flex-direction: column; gap: 4px; font-size: 13px; color: var(--kapyo-muted); }
    label.inline { flex-direction: row; align-items: center; gap: 8px; color: var(--kapyo-text); font-size: 14px; }
    input, textarea {
      padding: 9px 10px; border: 1px solid var(--kapyo-border); border-radius: 6px;
      font-size: 14px; color: var(--kapyo-text); font-family: inherit;
    }
    input:focus, textarea:focus { outline: 2px solid var(--kapyo-primary); border-color: transparent; }
    ...
    .preview { background: var(--kapyo-bg); padding: 14px; border-radius: 8px; }
    .preview h3 { margin: 0 0 8px; font-size: 13px; text-transform: uppercase; color: var(--kapyo-muted); letter-spacing: 0.05em; }
    ...
    .grand-total {
      margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--kapyo-border);
      display: flex; justify-content: space-between; align-items: center; font-size: 16px;
    }
    .grand-total strong { color: var(--kapyo-primary); font-size: 22px; }
    ...
    .orders li {
      ...
      padding: 10px 12px; border: 1px solid var(--kapyo-border); border-radius: 8px;
    }
    .orders li[data-status="failed"] { border-color: #fecaca; background: #fef2f2; }
    .orders li a { margin-left: auto; color: var(--kapyo-primary); font-size: 13px; }
  `],
})
